export const Grid = () => {
  return (
    <div className="flex flex-wrap xl:flex-nowrap xl:gap-x-8 text-black xl:mx-20 mx-4">
      <div className="bg-[#32F6C7] flex flex-col rounded-xl xl:rounded-[40px] p-3 xl:p-20 justify-between max-w-lg my-4 xl:my-0">
        <img
          src="https://cdn.prod.website-files.com/63dae19244d432799bf5baa4/63e0839dd3e9be14a3914ebf_you%20first.svg"
          alt="icon1"
          className="w-[22.95px] xl:w-25"
        />
        <div>
      ...
      <div className="space-y-5">
        <div className="bg-white flex flex-col justify-between p-3 xl:p-20 rounded-xl xl:rounded-[40px] xl:min-h-[50vh]">
          <img
        ...
        <div className="flex flex-wrap xl:flex-nowrap xl:gap-x-8">
          <div className="bg-[#F6FA5E] flex flex-col justify-between xl:min-h-[50vh] p-4 xl:p-20 rounded-xl xl:rounded-[40px] xl:max-w-[50%] mb-4 xl:mb-0">
            <img
              src="https://cdn.prod.website-files.com/63dae19244d432799bf5baa4/63e0839d8b6096bf904e78ff_hide%20nothing.svg"
              alt="icon3" className="w-[22.95px] xl:w-25"
            />
            <div>
          ...
          <div className="bg-[#60C6FF] flex flex-col justify-between xl:p-20 p-4 xl:min-h-[50vh] max-w-full rounded-xl xl:rounded-[40px]">
            <img src="https://cdn.prod.website-files.com/63dae19244d432799bf5baa4/63e0839dd88ab866125f49fd_fresh%20angles.svg" alt="icon4" className="w-[22.95px] xl:w-25" />
            <div>
