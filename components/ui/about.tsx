export const About = () => {
  return (
    <div className="flex flex-wrap md:flex-nowrap text-white mx-10 md:mx-20 xl:mx-52 justify-between xl:my-20 my-5 md:gap-x-5 gap-x-32">
      ...
      <div className="flex flex-col justify-evenly capitalize font-fk-display text-lg font-medium gap-y-2 mt-5 md:gap-y-5 md:text-[14px] md:font-semibold xl:text-[21px] xl:gap-y-10  xl:mt-0">
        <div className="leading-5 xl:leading-7">
          <div>dirbble</div>
          <div>instagram</div>
          <div>x</div>
          <div>facebook</div>
        ...
        <div className="leading-5 xl:leading-7">
          ...
          <div>Suite 205,</div>
          <div>North Port, Florida, 34287</div>
        </div>
