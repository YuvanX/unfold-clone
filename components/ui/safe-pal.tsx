...
export const SafePal = () => {
  return (
    <div className="px-4 my-10 md:my-5 md:px-8 xl:min-h-screen xl:px-20">
      <div className="relative bg-black rounded-xl  p-2 md:p-4 md:rounded-4xl xl:p-10 xl:rounded-[40px]">
        ...
        <div className="absolute bottom-5 left-40 md:bottom-10 md:left-100 xl:bottom-20 xl:left-1/2">
          <CustomButton />
        </div>
      </div>
    </div>
