...
export const Partner = () => {
  ...
  return (
    <div className="min-h-[200px] text-black bg-white rounded-xl px-4 py-2 mx-2  xl:rounded-[40px] xl:mx-20 xl:min-h-screen">
      <div className="flex items-center justify-between  xl:pl-20 xl:pr-10 xl:py-12">
        <div className="flex flex-col xl:h-[800px]  justify-between">
          <div className="capitalize text-[32px]/7 xl:text-9xl font-fk-display font-medium">
            friends & partners
          </div>
          <div className="flex flex-col gap-y-8 mt-5  xl:flex-row xl:gap-x-20 ">
        ...
        <div className="bg-[#21242C] w-2/3 max-h-[320px] xl:min-w-[600px] xl:min-h-[900px] xl:max-h-[900px] rounded-xl xl:rounded-[40px]  overflow-hidden">
